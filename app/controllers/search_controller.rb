...
class SearchController < ApplicationController
    def get_xml
        ...
        url = URI.parse("http://export.arxiv.org/api/query?search_query=abs:#{search_word}+OR+au:#{search_word}&start=#{page*30}&max_results=30&sortBy=lastUpdatedDate&sortOrder=descending")
